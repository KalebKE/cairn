"""Cairn CLI UI — Rich rendering helpers with graceful plain-text fallback."""
...
def print_stats_card(data: Dict[str, Any]) -> None:
    ...
    if RICH_AVAILABLE:
        lines = [
            "",
            "[bold white]Cairn[/bold white] [dim]Your Agent's Memory[/dim]",
            "",
            ...
            "",
            "[yellow]Star us on GitHub:[/yellow] [link=https://github.com/TracqiTechnology/cairn]github.com/TracqiTechnology/cairn[/link]",
            "",
        ]
        ...
        w = 45
        print("+" + "-" * w + "+")
        print("|" + "Cairn -- Your Agent's Memory".center(w) + "|")
        print("|" + " " * w + "|")
        ...
        print("|" + " " * w + "|")
        print("|" + "Star us: github.com/TracqiTechnology/cairn".center(w) + "|")
        print("+" + "-" * w + "+")
