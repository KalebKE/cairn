"""Shared SQLite utilities for Cairn.
...
logger = logging.getLogger("cairn.db_utils")

# SQLite retry — handles multi-process write contention on shared cairn.db.
...
def _enrich_and_raise_lock_error(original: Exception) -> None:
    ...
    try:
        ...
        diag = "Run `ps aux | grep cairn` to check for stale processes"
