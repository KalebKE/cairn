"""
Cairn SQLite Store -- SQLite-backed storage with sqlite-vec for vector search.

Replaces the in-memory graph system (CairnMemory) with a single SQLite database.
