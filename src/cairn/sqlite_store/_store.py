    ...
    def store(
        ...
        if len(content) > self._MAX_CONTENT_SIZE:
            raise StorageError(
                ...
                "Override with CAIRN_MAX_CONTENT_SIZE env var."
            )
        ...
        if embedding is None:
            from cairn.embedding import generate_embedding, get_embedding_model_info, is_embedding_degraded, get_active_backend
