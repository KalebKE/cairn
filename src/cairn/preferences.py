"""
Cairn Preference Extractor - Phase 1 of Memory Advancement
...
logger = logging.getLogger("cairn.preferences")
...
def store_extracted_preferences(
    ...
    try:
        ...
        logger.warning("Cairn not available, cannot store preferences")
        return {
            "extracted": len(extracted),
            "stored": 0,
            "conflicts": 0,
            "superseded": 0,
            "error": "Cairn not available",
        }
