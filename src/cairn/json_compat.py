"""
Cairn JSON Compatibility Wrapper - orjson for hot paths, stdlib fallback.
Drop-in replacement: import cairn.json_compat as json
Rollback: CAIRN_USE_STDLIB_JSON=1
"""

import os
import json as _json

_USE_ORJSON = os.environ.get("CAIRN_USE_STDLIB_JSON") != "1"
try:
    if _USE_ORJSON:
