"""Cairn adapter — uses SQLiteStore for memory storage and retrieval."""
...
class CairnAdapter(MemorySystemAdapter):
    """Adapter wrapping Cairn's SQLiteStore."""
    ...
    def _init_store(self) -> None:
        ...
        self._tmpdir = tempfile.mkdtemp(prefix="memorystress_cairn_")
        os.environ["CAIRN_HOME"] = self._tmpdir
